...
public class UserPrincipal implements UserDetails {
    ...
    public static UserPrincipal create(AuthorizationEntity authorizationEntity) {
        GrantedAuthority authority = new SimpleGrantedAuthority(authorizationEntity.getUserType().toString());

        return new UserPrincipal(
                new AuthorizationEntity(authorizationEntity.getId(), authorizationEntity.getPassword(), authorizationEntity.getUserType()),
                authority
        );
    }
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        ...
        authority.add(new SimpleGrantedAuthority(authorizationEntity.getUserType().toString()));
        return authority;
    }
